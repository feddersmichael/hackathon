...
def run(simulation: Simulation,
    ...
    simulation.simulation_raw_data.field = simulation.simulation_raw_data.field[:,:,:2,min_indices[0]:max_indices[0], min_indices[1]:max_indices[1], min_indices[2]:max_indices[2],:]
    ...
    optimizer_gen = GeneticOptimizer(cost_function=cost_function, population_size=200, generations=10000, mutation_rate=0.5, crossover_rate=0.6, timeout=2*60)
